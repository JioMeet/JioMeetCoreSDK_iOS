specVersion = '2.3.0'
frameworkSourceUrl = 'https://storage.googleapis.com/cpass-sdk/libs/iOS/public/new_arch/2_3_0/JioMeetChatUIKit.xcframework.zip'
...
Pod::Spec.new do |spec|
    ...
    spec.summary      = 'JioMeet iOS Chat UI SDK'
