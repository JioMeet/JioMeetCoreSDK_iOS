Pod::Spec.new do |spec|
    ...
    spec.source       = { :http => 'https://storage.googleapis.com/cpass-sdk/libs/iOS/public/new_arch/2_0_1/JioMeetUIKit.xcframework.zip' }
    spec.vendored_frameworks = 'JioMeetUIKit.xcframework'
    spec.dependency 'JioMeetCoreSDK_iOS', '0.0.3'
end